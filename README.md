...
You will want to obtain the initial CIViC data set and load it using `rake civic:import['GeneVariant.tsv','ClinicalEvidence.tsv']`. See 'Releases' from this repo for sample data to import.
