...
You will want to obtain the initial CIViC data set and load it using `rake civic:import['GeneVariant.tsv','ClinicalEvidence.tsv']`. Contact the authors for a copy.
