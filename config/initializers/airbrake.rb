...
Airbrake.configure do |c|
  ...
  c.project_id = ENV['CIVIC_AIRBRAKE_PROJECT_ID'] || Rails.application.secrets.airbrake_project_id
  c.project_key = ENV['CIVIC_AIRBRAKE_PROJECT_KEY'] || Rails.application.secrets.airbrake_project_key
