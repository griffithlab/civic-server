...
--
-- Name: community_members; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE community_members (
    ...
    most_recent_event_timestamp timestamp without time zone,
    event_count bigint
);

ALTER TABLE ONLY community_members REPLICA IDENTITY NOTHING;
...
CREATE RULE "_RETURN" AS
    ON SELECT TO community_members DO INSTEAD  SELECT DISTINCT users.id,
    users.email,
    users.name,
    users.url,
    users.username,
